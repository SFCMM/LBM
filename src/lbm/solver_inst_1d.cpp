...
extern template class LBMSolver<Debug_Level::no_debug, LBMethodType::D1Q3, LBEquationType::Poisson>;
template class LBMSolver<Debug_Level::no_debug, LBMethodType::D1Q3, LBEquationType::Poisson>;
extern template class LBMSolver<Debug_Level::debug, LBMethodType::D1Q3, LBEquationType::Poisson>;
template class LBMSolver<Debug_Level::debug, LBMethodType::D1Q3, LBEquationType::Poisson>;
extern template class LBMSolver<Debug_Level::max_debug, LBMethodType::D1Q3, LBEquationType::Poisson>;
template class LBMSolver<Debug_Level::max_debug, LBMethodType::D1Q3, LBEquationType::Poisson>;
