...
#include <boost/stacktrace/safe_dump_to.hpp> // boost_internal::stacktrace::detail::native_frame_ptr_t
#include <boost/stacktrace/detail/void_ptr_cast.hpp>

#include <boost/stacktrace/detail/push_options.h>

/// @file boost_internal/stacktrace/detail/frame_decl.hpp
/// Use <boost_internal/stacktrace/frame.hpp> header instead of this one!

namespace boost { namespace stacktrace {

/// @class boost_internal::stacktrace::frame boost_internal/stacktrace/detail/frame_decl.hpp <boost_internal/stacktrace/frame.hpp>
