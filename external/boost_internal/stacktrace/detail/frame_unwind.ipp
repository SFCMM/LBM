...
#include "boost_internal/stacktrace/frame.h"

#include "boost_internal/stacktrace/detail/to_hex_array.hpp"
#include "boost_internal/stacktrace/detail/location_from_symbol.hpp"
#include "boost_internal/stacktrace/detail/to_dec_array.hpp"
//#include "boost_internal/core/demangle.hpp"
...
//#   include <boost_internal/stacktrace/detail/libbacktrace_impls.hpp>
//#elif defined(BOOST_STACKTRACE_USE_ADDR2LINE)
#   include "boost_internal/stacktrace/detail/addr2line_impls.h"
//#else
//#   include <boost_internal/stacktrace/detail/unwind_base_impls.hpp>
//#endif
...
public:
    std::string operator()(boost::stacktrace::detail::native_frame_ptr_t addr) {
        ...
        if (!Base::res.empty()) {
            Base::res = demangle(Base::res.c_str());
        } else {
